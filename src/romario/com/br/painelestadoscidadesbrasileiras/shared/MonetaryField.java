 ...
 * @author Romário Cabó
 */
public class MonetaryField extends PlainDocument {

    public static final int NUMERO_DIGITOS_MAXIMO = 12;
    private static final long serialVersionUID = 8912641356071026310L;
    ...
    public void insertString(int offs, String str, AttributeSet a) throws BadLocationException {
        ...
        if (texto.length() < MonetaryField.NUMERO_DIGITOS_MAXIMO) {
